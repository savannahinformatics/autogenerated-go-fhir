...
// MedicinalProductUndesirableEffect ... // TODO Write proper comment
...
func (x *MedicinalProductUndesirableEffect) MarshalJSON() ([]byte, error) {
...
func (x *MedicinalProductUndesirableEffect) checkResourceType() error {
	if x.ResourceType == "" {
		...
		return fmt.Errorf("Expected resourceType to be MedicinalProductUndesirableEffect, instead received %s", x.ResourceType)
	}
	return nil
}

// MedicinalProductUndesirableEffectPlus ... // TODO Write proper comment
...
// MedicinalProductUndesirableEffectPlusRelatedResources ... // TODO Write proper comment
