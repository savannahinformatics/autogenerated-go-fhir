...
func (x *Basic) MarshalJSON() ([]byte, error) {
...
func (x *Basic) checkResourceType() error {
	if x.ResourceType == "" {
		...
		return fmt.Errorf("Expected resourceType to be Basic, instead received %s", x.ResourceType)
	}
	return nil
}
...
// GetIncludedPatientResourceReferencedByAuthor ...
...
// GetIncludedRelatedPersonResourceReferencedByAuthor ...
